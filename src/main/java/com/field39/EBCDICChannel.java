 ...
 * @see ISOChannel
 */
public class EBCDICChannel extends BaseChannel {

    /** Number of digits for the message length header */
    protected int lengthDigits= 2;                                      // 4 is default
     ...
     * @see ISOPackager
     */
    public EBCDICChannel (String host, int port, ISOPackager p) {
        super(host, port, p);
    }
    /**
     ...
     * @see ISOPackager
     */
    public EBCDICChannel (ISOPackager p) throws IOException {
        super(p);
    }
    /**
     ...
     * @see ISOPackager
     */
    public EBCDICChannel (ISOPackager p, ServerSocket serverSocket) 
        throws IOException
    {
