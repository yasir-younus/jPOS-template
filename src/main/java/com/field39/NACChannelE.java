 ...
 * @see ISOChannel
 */
public class NACChannelE extends BaseChannel {
    /**
     * Public constructor 
     */
     ...
     * @see ISOPackager
     */
    public NACChannelE (String host, int port, ISOPackager p, byte[] TPDU) {
        super(host, port, p);
        this.header = TPDU;
    }
    /**
     ...
     * @see ISOPackager
     */
    public NACChannelE (ISOPackager p, byte[] TPDU) throws IOException {
        super(p);
        this.header = TPDU;
    }
    /**
     ...
     * @see ISOPackager
     */
    public NACChannelE (ISOPackager p, byte[] TPDU, ServerSocket serverSocket) 
        throws IOException
    {
